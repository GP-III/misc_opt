...
void async_callback_set_default_stream_end (void *cbm);
void async_callback_set_default_pass_end (void *cbm);
void async_callback_set_default_pass_start (void *cbm);
void async_callback_set_default_buffer_end (void *cbm);
void async_callback_set_default_buffer_start (void *cbm);
void async_callback_set_default_loop_end (void *cbm);
void async_callback_set_default_event_error (void *cbm);
void async_callback_set_default_callback_destroy (void *cbm);
/* callback-register Not suitable for ILP64 */
